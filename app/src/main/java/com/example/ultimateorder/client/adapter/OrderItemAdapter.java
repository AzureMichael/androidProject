...
public class OrderItemAdapter extends ArrayAdapter<OrderItem> implements View.OnClickListener {
    ...
    @SuppressLint("SetTextI18n")
    public void openDialog(OrderItem orderItem, OrderViewModel orderViewModel, View view) {
        ...
        String s = "order" + ((TextView) view.findViewById(R.id.id))
                .getText()
                .subSequence(8, ((TextView) view.findViewById(R.id.id)).getText().length())
                .toString();
        ...
        firebaseFirestore.collection("orders").document(s).collection("mealItems").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "CANCEL", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // Delete order from menu and database
                                ...
                                firebaseFirestore
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        orderItem.get().setPrice(Float.valueOf(((TextView) view.findViewById(R.id.price))
                                                .getText()
                                                .subSequence(7, ((TextView) view.findViewById(R.id.price)).getText().length())
                                                .toString()));
